...
namespace InstagramTools.Api.Common.Helpers
{
    public class UriCreator
    {
        ...
        public static Uri GetUserFollowersUri(string userPk, string rankToken, string maxId = "")
        {
            Uri instaUri;
            if (
        ...
        {
            Uri instaUri;
            if (!Uri.TryCreate(BaseInstagramUri, string.Format(InstaApiConstants.DELETE_MEDIA, mediaId, (int)mediaType), out instaUri))
